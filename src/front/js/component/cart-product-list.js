                    ...
                    <div className="container-fluid mb-5">
                        ...
                        {store.cart.map((item) => {
                            return (
                                <>
                                    <div className="p-2">
                                        <ListProduct edit={edit} name={item.modelo} description={item.descripcion} quantity={item.cantidad} image={item.image} tipo={item.tipo} user_id={user_id} product_id={item.product_id} />
                                    </div>
                                </>
                            )
                        })}
