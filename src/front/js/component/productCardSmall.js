    ...
    return (
        <div className="container content-small-card">
            <div className="col-md-12">
                <div className="card border-0 w-100 mb-4 text-black rounded-4 mx-auto d-flex flex-column" onClick={sendToIndividualProduct} style={{ height: '400px', backgroundColor: "rgb(255, 255, 255)" }}>
